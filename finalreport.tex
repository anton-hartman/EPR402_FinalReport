...
\captionsetup[subfigure]{format=default, singlelinecheck=false}
% Define a 'nonhang' format and set it for subcaptions
% \DeclareCaptionFormat{nonhang}{\hspace*{1pt}#1#2\\ #3}
% \captionsetup[subfigure]{format=nonhang, indention=0cm, singlelinecheck=false}
